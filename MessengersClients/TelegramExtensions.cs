...
{
    public static TelegramAdapter GetAdapter(this ITelegramBotClient client) => new(client);

    private static Chat GetAdapter(this Telegram.Bot.Types.Chat chat) => new(chat.Id, chat.Username);
